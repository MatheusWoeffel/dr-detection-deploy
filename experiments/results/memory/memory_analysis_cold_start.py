...
memory_1gb = pd.read_csv(f"./cold-start-{model_name}-1gb.csv")
memory_2gb= pd.read_csv(f"./cold-start-{model_name}-2gb.csv")
memory_3gb = pd.read_csv(f"./cold-start-{model_name}-3gb.csv")
...
plt.savefig(f'cold-start-{model_name}-{metric_to_analyze}.eps', bbox_inches='tight', format="eps")
# show plot
plt.show()